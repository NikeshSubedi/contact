...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        // table has the fields id, name, phone
        ...
        String SQL = "CREATE TABLE contact (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, phone TEXT)";
    ...
    public Contact getContact(String id) {
        ...
        Contact contacts = new Contact(ids, name, phone);
        db.close();
        return contacts;
